...
template <class T>
TVM_DLL T Uint32ToAI23Float32(uint32_t in) {
...
template <class T>
TVM_DLL uint32_t AI23Float32ToUint32(T in) {
...
extern "C" {
TVM_DLL uint32_t MinAI23Float32() {
  // return minimum representable value
  float min = std::numeric_limits<float>::lowest();
  return AI23Float32ToUint32<float>(min);
}

TVM_DLL float AI23Float32ToFloat(uint32_t in) {
  // cast from custom datatype to float
  float custom_datatype = Uint32ToAI23Float32<float>(in);
...
TVM_DLL uint32_t FloatToAI23Float32(float in) {
  // cast from float to custom datatype
  return AI23Float32ToUint32<float>(in);
}

TVM_DLL uint32_t AI23Float32Add(uint32_t a, uint32_t b) {
  // add operation
  float acustom = Uint32ToAI23Float32<float>(a);
  float bcustom = Uint32ToAI23Float32<float>(b);
  return AI23Float32ToUint32<float>(acustom + bcustom);
}

TVM_DLL uint32_t AI23Float32Sub(uint32_t a, uint32_t b) {
  // subtract
  float acustom = Uint32ToAI23Float32<float>(a);
  float bcustom = Uint32ToAI23Float32<float>(b);
  return AI23Float32ToUint32<float>(acustom - bcustom);
...
TVM_DLL uint32_t AI23Float32Mul(uint32_t a, uint32_t b) {
  // multiply
  float acustom = Uint32ToAI23Float32<float>(a);
  float bcustom = Uint32ToAI23Float32<float>(b);
  return AI23Float32ToUint32<float>(acustom * bcustom);
...
TVM_DLL uint32_t AI23Float32Div(uint32_t a, uint32_t b) {
  // divide
  float acustom = Uint32ToAI23Float32<float>(a);
  float bcustom = Uint32ToAI23Float32<float>(b);
  return AI23Float32ToUint32<float>(acustom / bcustom);
...
TVM_DLL uint32_t AI23Float32Max(uint32_t a, uint32_t b) {
  // max
  float acustom = Uint32ToAI23Float32<float>(a);
  float bcustom = Uint32ToAI23Float32<float>(b);
  return AI23Float32ToUint32<float>(acustom > bcustom ? acustom : bcustom);
}

TVM_DLL uint32_t AI23Float32Sqrt(uint32_t a) {
  // sqrt
  float acustom = Uint32ToAI23Float32<float>(a);
  return AI23Float32ToUint32<float>(sqrt(acustom));
}

TVM_DLL uint32_t AI23Float32Exp(uint32_t a) {
  // exponential
  float acustom = Uint32ToAI23Float32<float>(a);
  return AI23Float32ToUint32<float>(exp(acustom));
}

TVM_DLL uint32_t AI23Float32Log(uint32_t a) {
  // log
  float acustom = Uint32ToAI23Float32<float>(a);
  return AI23Float32ToUint32<float>(log(acustom));
}

TVM_DLL uint32_t AI23Float32Sigmoid(uint32_t a) {
  // sigmoid
  float acustom = Uint32ToAI23Float32<float>(a);
  float one = 1.0f;
  return AI23Float32ToUint32<float>(one / (one + exp(-acustom)));
}

TVM_DLL uint32_t AI23Float32Tanh(uint32_t a) {
  // tanh
  float acustom = Uint32ToAI23Float32<float>(a);
  return AI23Float32ToUint32<float>(tanh(acustom));
}
}
